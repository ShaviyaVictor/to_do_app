...
Installs the cloned app then proceed to the running step in development mode.
...
This project is licensed under the [MIT License](https://github.com/ShaviyaVictor/to_do_app/blob/main/LICENSE).           
